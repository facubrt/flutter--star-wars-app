...
import 'package:starwapp/src/presentation/views/pages/detail/widgets/description_list_widget.dart';
import 'package:starwapp/src/presentation/views/pages/detail/widgets/resume_widget.dart';
import 'package:starwapp/src/presentation/views/pages/detail/widgets/starships_list_widget.dart';
import 'package:starwapp/src/presentation/views/pages/detail/widgets/vehicles_list_widget.dart';
import 'package:starwapp/src/presentation/views/widgets/text_button_app.dart';
import 'package:starwapp/src/presentation/views/widgets/title_widget.dart';

import '../../../logic/provider/sw_provider.dart';
        ...
        children: [
          ...
          prefs.connection
              ...
              : TextButtonApp(
                  ...
                  onPressed: () async {
                    final String? resultMsg = await swProvider.postReport(
