...
class _$_Starship implements _Starship {
  const _$_Starship({required this.name, required this.model});
  ...
  @override
  String toString() {
    return 'Starship(name: $name, model: $model)';
  }
...
abstract class _Starship implements Starship {
  const factory _Starship(
      {required final String name, required final String model}) = _$_Starship;
